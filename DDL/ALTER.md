...
```sql
ALTER TABLE TEST_TABLE20
ADD CONSTRAINTS TEST_TABLE20_DATA3_FK FOREIGN KEY(DATA3)
...
```sql
ALTER TABLE TEST_TABLE20
ADD CONSTRAINTS TEST_TABLE20_DATA4_UK UNIQUE(DATA4);
```
...
```sql
ALTER TABLE TEST_TABLE20
ADD CONSTRAINTS TEST_TABLE20_DATA5_CK CHECK(DATA5 BETWEEN 1 AND 10);
```
...
```sql
ALTER TABLE TEST_TABLE20
ADD CONSTRAINTS TEST_TABLE20_DATA6_CK CHECK(DATA6 IN (10, 20 ,30));
```
...
DROP CONSTRAINTS TEST_TABLE30_DATA2_PK;
```
...
```sql
ALTER TABLE TEST_TABLE30
DROP CONSTRAINTS TEST_TABLE30_DATA3_FK;
```
...
```sql
ALTER TABLE TEST_TABLE30
DROP CONSTRAINTS TEST_TABLE30_DATA4_UK;
```
...
```sql
ALTER TABLE TEST_TABLE30
DROP CONSTRAINTS TEST_TABLE30_DATA5_CK;

ALTER TABLE TEST_TABLE30
DROP CONSTRAINTS TEST_TABLE30_DATA6_CK;
```
